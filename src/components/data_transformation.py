...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        - Numerical columns: impute missing values with median, then scale
        - Categorical columns: impute with most frequent, then one-hot encode, then scale
        """
        try:
    ...
    def initiate_data_transformation(self, train_data_path: str, test_data_path: str):
        """
        Apply preprocessing on train and test datasets,
        then save the preprocessor object.
        """
        try:
            # Read CSVs
            ...
            logging.info(
                f"Saved preprocessing object at {self.data_transformation_config.preprocessor_obj_file_path}"
            )
